...
from tiny_vit_transformer_from_scratch.core.config import Config
from tiny_vit_transformer_from_scratch.data.vit_custom_dataset import VitCustomDataset
...
class DataPreprocessor:
    def __init__(self, config: Config):
        ...
        self.classes = config.classes[:self.max_img_cls]
        ...
        self.train_transforms = transforms.Compose([
            transforms.RandomResizedCrop(self.img_size, scale=(0.5, 1.0), interpolation=InterpolationMode.BICUBIC),
    ...
    def create_dataloaders(self):
        ...
        test_loader = DataLoader(test_data, batch_size=self.batch_size, shuffle=False, num_workers=self.num_users, pin_memory=self.pin_memory)
